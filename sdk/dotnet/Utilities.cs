...
namespace Lbrlabs.PulumiPackage.Awscontroltower
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Lbrlabs.PulumiPackage.Awscontroltower.version.txt");
    ...
    internal sealed class AwscontroltowerResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AwscontroltowerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
